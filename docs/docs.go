...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/application.UserProfileDTO"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/application.CompleteUserProfileCommand"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "application.CompleteUserProfileCommand": {
            "type": "object",
            "properties": {
                "avatar_url": {
                    "type": "string"
